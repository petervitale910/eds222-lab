...
**Q1: What is the appropriate statistic for this question?** Difference in proportions
...
se_p_hat <- sqrt(p_hat*(1-p_hat)*((1/n2)+(1/n1)))
...
I would interpret that number as not enough information. Based on the critical threshhold we would accept the null hypothesis. There's an 8% chance that the difference in popsicle sticks and garden staples is due to random chance.
...
diff_props_ci <- qnorm(c(.025,.975), mean = diff_props, sd = se_diff_props)
...
-   Im 95% confident the difference between I'm 95% confident the difference is between -.06 and .34
...
-   Sampling distribution given the null hypothesis being true
